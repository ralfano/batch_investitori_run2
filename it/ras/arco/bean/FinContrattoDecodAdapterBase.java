...
/*    */ 
/*    */ 
/*    */ public class FinContrattoDecodAdapterBase
/*    */   extends FinContrattoDecod
...
/*    */ 
/*    */   
/*    */   public String getContattoDecodIdAdp() {
/* 47 */     AdapterUtils utils = AdapterUtils.getInstance();
/* 48 */     return utils.getStringProperty(this, "contattoDecodId", utils.getLocale(), utils.getPatternManager().getBeanPatterns(getClass().getName()));
/*    */   }
/*    */   
/*    */   public void setContattoDecodIdAdp(String contattoDecodId) {
/* 52 */     AdapterUtils utils = AdapterUtils.getInstance();
/* 53 */     utils.setStringProperty(this, "contattoDecodId", contattoDecodId, utils.getLocale(), utils.getPatternManager().getBeanPatterns(getClass().getName()));
/*    */   }
/*    */   
...
/* Location:              C:\Users\rosario.alfano\OneDrive - Accenture\Desktop\batch_investitori\Run 2\common-core-1.7.8.jar!\it\ras\arco\bean\FinContrattoDecodAdapterBase.class
