...
/*    */ 
/*    */ 
/*    */ public class FinPortafoglioFondiAdapterBase
/*    */   extends FinPortafoglioFondi
...
/*    */ 
/*    */   
/*    */   public String getDataComposizioneAdp() {
/* 47 */     AdapterUtils utils = AdapterUtils.getInstance();
/* 48 */     return utils.getStringProperty(this, "dataComposizione", utils.getLocale(), utils.getPatternManager().getBeanPatterns(getClass().getName()));
/*    */   }
/*    */   
/*    */   public void setDataComposizioneAdp(String dataComposizione) {
/* 52 */     AdapterUtils utils = AdapterUtils.getInstance();
/* 53 */     utils.setStringProperty(this, "dataComposizione", dataComposizione, utils.getLocale(), utils.getPatternManager().getBeanPatterns(getClass().getName()));
/*    */   }
/*    */   
...
/* 88 */     return utils.getStringProperty(this, "portafoglioId", utils.getLocale(), utils.getPatternManager().getBeanPatterns(getClass().getName()));
/*    */   }
/*    */   
/*    */   public void setPortafoglioIdAdp(String portafoglioId) {
/* 92 */     AdapterUtils utils = AdapterUtils.getInstance();
/* 93 */     utils.setStringProperty(this, "portafoglioId", portafoglioId, utils.getLocale(), utils.getPatternManager().getBeanPatterns(getClass().getName()));
/*    */   }
/*    */ }


/* Location:              C:\Users\rosario.alfano\OneDrive - Accenture\Desktop\batch_investitori\Run 2\common-core-1.7.8.jar!\it\ras\arco\bean\FinPortafoglioFondiAdapterBase.class
