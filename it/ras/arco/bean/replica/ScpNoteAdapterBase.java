...
/*    */ 
/*    */ 
/*    */ public class ScpNoteAdapterBase
/*    */   extends ScpNote
...
/*    */   }
/*    */   
/*    */   public String getNotaIdAdp() {
/* 77 */     AdapterUtils utils = AdapterUtils.getInstance();
/* 78 */     return utils.getStringProperty(this, "notaId", utils.getLocale(), utils.getPatternManager().getBeanPatterns(getClass().getName()));
/*    */   }
/*    */   
/*    */   public void setNotaIdAdp(String notaId) {
/* 82 */     AdapterUtils utils = AdapterUtils.getInstance();
/* 83 */     utils.setStringProperty(this, "notaId", notaId, utils.getLocale(), utils.getPatternManager().getBeanPatterns(getClass().getName()));
/*    */   }
/*    */   
/*    */   public String getTestoVariabileAdp() {
/* 87 */     AdapterUtils utils = AdapterUtils.getInstance();
/* 88 */     return utils.getStringProperty(this, "testoVariabile", utils.getLocale(), utils.getPatternManager().getBeanPatterns(getClass().getName()));
/*    */   }
/*    */   
/*    */   public void setTestoVariabileAdp(String testoVariabile) {
/* 92 */     AdapterUtils utils = AdapterUtils.getInstance();
/* 93 */     utils.setStringProperty(this, "testoVariabile", testoVariabile, utils.getLocale(), utils.getPatternManager().getBeanPatterns(getClass().getName()));
/*    */   }
/*    */ }


/* Location:              C:\Users\rosario.alfano\OneDrive - Accenture\Desktop\batch_investitori\Run 2\common-core-1.7.8.jar!\it\ras\arco\bean\replica\ScpNoteAdapterBase.class
